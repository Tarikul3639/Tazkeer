    ...
    <header className="w-full px-4 py-3 bg-blue-50 border-blue-100">
      <div className="flex items-center justify-between">
        ...
        <div className="group flex items-center gap-3">
          ...
          <div className="bg-blue-50 rounded-2xl flex items-center justify-center transform rotate-0 group-hover:[transform:rotate(9deg)_scale(1.02)] transition-all duration-500 shadow-[0_4px_12px_rgba(59,130,246,0.15)] p-2">
            <Watch size={28} className="text-blue-600" />
          </div>
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            disabled
            className="p-2 disabled:opacity-50 hover:cursor-not-allowed text-blue-900/60 hover:text-blue-600 hover:bg-white rounded-xl transition-all relative group">
